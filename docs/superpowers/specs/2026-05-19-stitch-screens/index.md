...
| 2 | חיפוש וסריקה (Search & Scan) | `search-scan` | `search_scan_screen.dart` | ✓ | ✓ | ✓ | ⚠ (SS1–SS8, §7.8 — SS6 heading typo + icon fixed #71) | ⬜ | `b075f5753b7948a9bb115786f1b922ed` |
...
| 17 | Contact Us (Updated) | `contact-us` | `contact_screen.dart` | ✓ | ✓ | ✓ | ⚠ (CC1–CC3, CC5–CC7, §7.7 — CC4 false-success fixed #17; subject picker added §4.3 #84) | ⬜ | `5a9bc40c2d8a46c7b760d2725cde2cf4` |
| 18 | Report Issue | `report-issue` | `feedback_screen.dart` | ✓ | ✓ | ✓ | ⬜ | ⬜ | `a6741117c9f14b84938c4abda143a5dd` |
| 19 | דיווח נשלח בהצלחה (Success Confirmation) | `report-success` | `feedback_success_screen.dart` | ✓ | ✓ | ✓ | ✓ (RS1–RS9 rebuilt to spec #18) | ⬜ | `4bb210f9ac7143e0a6d1558dd950a62d` |
