...
class AppColorsExt extends ThemeExtension<AppColorsExt> {
  ...
  static const AppColorsExt _dark = AppColorsExt(
    borderSubtle: Color(0xFF3F4752),
    iconMuted: Color(0xFF6B7280),
    slate600: Color(0xFF94A3B8),
    primaryTint: Color(0xFF001B3D),
    primaryTintBorder: Color(0xFF1A3A6E),
    frostedSurface: Color(0xE6000000),
    closeButtonOverlay: Color(0x66000000),
    cameraSurfaceUnavailable: Color(0xFF0A0E14),
    scanFrame: Color(0xFF4DAEFF),
    safeBackground: Color(0xFF103A1E),
    safeText: Color(0xFF6FD68A),
    cautionBackground: Color(0xFF3D2E05),
    cautionText: Color(0xFFF5C04E),
    cautionHighlight: Color(0xFFF5A623),
    avoidBackground: Color(0xFF44181A),
    avoidText: Color(0xFFF2897F),
    avoid: Color(0xFFCF6679),
    onAvoid: Color(0xFFFFFFFF),
    success: Color(0xFF34B5A5),
    onSuccess: Color(0xFF003731),
    warning: Color(0xFFFFB74D),
    warningContainer: Color(0xFF4A2C00),
    chipDisplayBg: Color(0xFF001B3D),
    chipDisplayBorder: Color(0xFF1D4280),
    chipDetectedBg: Color(0xFF3D0000),
    chipDetectedBorder: Color(0xFF9B1010),
    chipDetectedFg: Color(0xFFFF8A80),
    chipCautionBg: Color(0xFF3D2800),
    chipCautionBorder: Color(0xFFF5A623),
    chipCautionFg: Color(0xFFF5A623),
    destructiveSubtle: Color(0xFF3D0010),
    onDestructiveSubtle: Color(0xFFFF80AB),
  );
  ...
  AppColorsExt lerp(AppColorsExt? other, double t) {
    ...
    return AppColorsExt(
      ...
      avoidBackground:
          Color.lerp(avoidBackground, other.avoidBackground, t)!,
