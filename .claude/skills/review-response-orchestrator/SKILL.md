...
`🟠` (major), `🟡` (minor), or `🟢` (nit). ALL unresolved severity threads are
actionable review-response work. Only `ported to #N` / "clean" threads are
non-blocking and NOT actionable.
